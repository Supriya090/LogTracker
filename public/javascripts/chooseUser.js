$(document).ready(function (e) {
  ...
  function addStud() {
    ...
    var new_input = "<input class='button-type' id='newStud_" + new_student_no + "' name='std" + new_student_no + "' value ='" + userSelect.options[userSelect.selectedIndex].text + "' readonly/>"
    new_student_no++;
